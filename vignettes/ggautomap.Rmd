...
covid_cases_nsw %>%
  ...
  coord_automap_zoom(datum = NA, feature_type = "nswgeo.lga") +
  theme_minimal()
```
...
covid_cases_nsw %>%
  ...
  geom_inset_frame() +
  coord_automap(datum = NA, feature_type = "nswgeo.lhd", inset = configure_inset(
...
covid_cases_nsw %>%
  ...
  geom_boundaries(feature_type = "nswgeo.lhd") +
  geom_inset_frame() +
  geom_sf_label_inset(aes(label = lhd), stat = "automap_coords",
...
massaging since they don't natively understand the spatial data.

```{r text-repel, fig.height = 3, fig.width = 7}
library(ggrepel)
...
covid_cases_nsw %>%
  ...
  geom_boundaries(feature_type = "nswgeo.lhd") +
  geom_inset_frame() +
  geom_label_repel(aes(x = after_stat(x_inset),
